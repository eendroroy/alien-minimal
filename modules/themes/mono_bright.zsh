...
am_theme(){
  ...
  [[ -z ${AM_VI_INSERT_COLOR} ]]        && AM_VI_INSERT_COLOR=249
  [[ -z ${AM_VI_NORMAL_COLOR} ]]        && AM_VI_NORMAL_COLOR=249
  ...
  [[ -z ${AM_ELIXIR_COLOR} ]]           && AM_ELIXIR_COLOR=254
  [[ -z ${AM_CRYSTAL_COLOR} ]]          && AM_CRYSTAL_COLOR=8
  [[ -z ${AM_NODE_COLOR} ]]             && AM_NODE_COLOR=249
  [[ -z ${AM_PHP_COLOR} ]]              && AM_PHP_COLOR=248
  [[ -z ${AM_GRADLE_COLOR} ]]           && AM_GRADLE_COLOR=246
  [[ -z ${AM_MAVEN_COLOR} ]]            && AM_MAVEN_COLOR=250
